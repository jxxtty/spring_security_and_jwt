...
public class JwtTokenProvider {
    ...
    // 유저정보를 넘겨받아 Access Token과 Refresh Token을 생성한다.
    public TokenDto generateTokenDto(Authentication authentication) {
        ...
        // RefreshToken 생성 -> 아무런 정보를 담지 않는다.
    ...
    // UserDetails객체를 생성해서 UsernamePasswordAuthenticationToken형태로 리턴하는데, 이는 SecurityContext을 사용하기위한 절차
    // SecurityContext가 Authentication 객체를 저장한다.
    ...
    // token에서 정보를 꺼낸다. -> 만료된 토큰이라도 정보를 꺼내기 위해서 따로 분리함
